...
test_photovoltaic = Photovoltaic(test_coordinates, test_surface_tilt, test_surface_azimuth, test_dt)
...
test_file_columns = ['test_column1', 'test_column2', 'test_column3', 'test_column4']
